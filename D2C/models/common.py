...
class C3GAM(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(GAMAttention(c_, c_,shortcut) for _ in range(n)))
class C3ECA(C3):
    # C3 module with CBAMBottleneck()
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(ECA(c_, c_,shortcut) for _ in range(n)))  
...
class C3NAM(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(NAM(c_, c_,shortcut) for _ in range(n)))
...
class C3SE(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(SEAttention(c_,shortcut) for _ in range(n)))                         
...
class C3CA(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(CoordAtt(c_, c_,shortcut) for _ in range(n)))
...
class C3CBAMBASE(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(CBAM_BASE(c_, c_,shortcut) for _ in range(n)))  
...
class C3CONVCBAM(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(CBAM_CONV(c_, c_,shortcut) for _ in range(n)))              
...
class ASPP_2(nn.Module):
    ...
    def forward(self, x):
        ...
        net = self.conv_1x1_output(torch.cat([image_features, atrous_block1, atrous_block12,
